...
<title>Buy and Sell - Contact</title>
...
<div id="templatemo_wrapper">
	<div id="templatemo_header">
    	...
    	<div id="site_title">
        	<h1><a href="#">Buy and Sell</a></h1>
        </div>
        
        <div id="header_right">
	        <a href="#">My Account</a> | <a href="#">My Wishlist</a> | <a href="#">My Cart</a> | <a href="#">Checkout</a> | <a href="login.html">Log In</a>
		</div>
    ...
    <div id="templatemo_main">
        	...
        	<div class="sidebar_box"><span class="bottom"></span>
                ...
                <div class="content"> 
                	<ul class="sidebar_list">
                    	<li class="first"><a href="#">Lights</a></li>
                        ...
                        <li><a href="#">Stappler</a></li>
                        <li><a href="#">Engineering Items</a></li>
                        <li><a href="#">Mechanical Items</a></li>
        ...
        <div id="content" class="float_r">
            ...
            <h1>Contact Us</h1>
    Your form has been submitted with the following data:<br />
...
Message: <?php echo $_POST["message"]; ?><br />
    ...
    <div id="templatemo_footer">
    	...
    	Copyright © 2015 <a href="#">Buy and Sell</a>
